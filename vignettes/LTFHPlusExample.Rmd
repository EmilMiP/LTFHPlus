...
liabs = mvrnorm(n = N, mu = rep(0, 4 + nsib), Sigma = get_cov(h2, n_sib = nsib))
...
```
#### Generating phen
Next, we want to assign sex, status, age-of-onset(aoo) to each individual, including the family memebers.  
