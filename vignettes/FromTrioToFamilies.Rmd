...
The object `family` is meant to represent the trio information that can be found registers. It is possible to have multiple families in the same input data or single individuals with no family links.
...
Finally, the kinship matrix can be calculated in the following way:
```{r}
